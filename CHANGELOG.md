...
## [7.2.3.2] - 2026-09-10
### Changed
- Upgraded `sprockets` from `3.7.5` to `4.4.1` (resolves SCA finding NFG-4150).

### Fixed
- Precompiled `nfg_ui` `app_icon` assets in the Sprockets manifest so they resolve correctly under Sprockets 4's stricter asset lookup.
