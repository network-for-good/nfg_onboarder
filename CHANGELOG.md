...
The format follows [Keep a Changelog](https://keepachangelog.com/en/1.0.0/), and this project uses the version declared in `lib/nfg_onboarder/version.rb`. Note: between `0.0.3` (2018) and `7.2.0` (2025) the gem's version was not bumped even though it went through the `rails_5`, `rails_6`, `rails_6_1`, and `rails_7_2` upgrade branches — those releases predate changelog tracking and are not itemized below.
